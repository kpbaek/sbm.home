	...
	function create_user($data, $activated = TRUE)
	{
		...
		if ($this->db->insert(self::TABLE, $data)) {
			...
			$arr = array('send_id'=>'blumine',
				...
				'contents'=>'포럼회원 가입 축하합니다.<br><br>포럼에 질문 올리시기 전에 다음 사항을 지켜주시기 바랍니다.<br><br> 1. 매뉴얼에서 먼저 찾아본다.<br> 2. 기존 글에서 먼저 검색을 해본다.<br> 3. 질문을 올릴 때는 육하원칙에 의거 글을 작성한다.<br><br>아주 기본적인 사항들인데 잘 지켜지지 않습니다.<br><br>특히 3번을 준수하실 경우 양질의 답변을 빠르게 받아보실 수 있습니다. <br>그렇지 않은 경우엔 질문자와 답변자가 스무고개를 시작합니다.<br><br><br>즐거운 포럼 생활 되시기 바랍니다.',
				'ip'=>'127.0.0.1'
			) ;
